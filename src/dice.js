...
function reroll_noncrit(prob) {
    ...
    var noncrit_chance = 1.0 - prob.six_chance
...
function hits_of_6_add_hits(hits, bonus_hits_val, bonus_hit_chance, hit_six_chance) {
    ...
    var bonus_hits_prob = parse_dice_prob_array(bonus_hits_val, 1).normal;
...
function do_killed_40k(damage_prob, fnp, unsaved, wound_val) {
    ...
    if (wound_val) {
        for (var n = 0; n < unsaved.normal.length; n++) {
            ...
            var hit_killed = roll_n_dice_against_threshold(n, damage_prob, wound_val);
...
export { init_40k, generate_permalink_40k, roll_40k }